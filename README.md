...
**플로우 2: 거래내역 기반 정산**
```
신한SOL 거래내역 → 정산하기 → AI 추천 확인 → 연락처 선택 → 요청 전송
```
...
<div align="center">
 <img src="https://github.com/user-attachments/assets/0630edd2-167b-4151-9e4d-a5361cdd47e8" width="300">
</div>
...
cd SOL-settle/ios/SOL-settle
open SOL-settle.xcodeproj
```
